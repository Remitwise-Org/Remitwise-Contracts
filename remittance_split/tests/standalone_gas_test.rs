...
fn test_query_schedules_with_data_gas_measurement() {
    ...
    for i in 1..=5 {
        ...
        let schedule_id = client.create_remittance_schedule(&owner, &amount, &next_due, &interval);
        assert_eq!(schedule_id, i as u32, "Schedule {} creation should succeed", i);
    }
...
fn test_data_isolation_security() {
    ...
    for i in 1..=3 {
        ...
        assert_eq!(schedule_id, i as u32, "Owner1 schedule {} creation should succeed", i);
    }
    ...
    for i in 1..=2 {
        ...
        assert_eq!(schedule_id, (i + 3) as u32, "Owner2 schedule {} creation should succeed", i);
    }
...
fn test_input_validation_security() {
    ...
    assert_eq!(result, 1, "Valid parameters should succeed");
