...
pub enum RemittanceSplitError {
    ...
    InactiveSchedule = 14,         // NEW: cannot modify or cancel a deactivated schedule
    IntervalTooShort = 15,         // NEW: schedule interval < 1 hour
    LeadTimeTooLong = 16,          // NEW: schedule due date > 1 year
}
```
