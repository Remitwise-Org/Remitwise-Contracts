...
const MAX_POLICIES: u32 = 10_000;
pub const MAX_POLICIES_PER_OWNER: u32 = 100;
pub const INSURANCE_TOPIC: &str = "insurance";
const MAX_NAME_LEN: u32 = 64;
const MAX_EXT_REF_LEN: u32 = 128;
const THIRTY_DAYS_SECS: u64 = 30 * 24 * 3600;
const MAX_TENURE_SECS: u64 = 365 * 24 * 3600;
const MIN_SCHEDULE_INTERVAL: u64 = 24 * 3600;
const MAX_SCHEDULE_LEAD_TIME: u64 = 365 * 24 * 3600;
...
impl Insurance {
    ...
    pub fn calculate_discounted_premium(
        ...
        let policy = Self::load_policy(&env, policy_id).expect("Policy not found");
